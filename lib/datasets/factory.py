    ...
    def __init__(self,classes):
        ...
        for year in ['2007', '2012']:
            for split in ['train', 'val', 'trainval', 'test']:
                ...
                self.sets[name] = (lambda split=split, year=year:
        ...
        for top_k in np.arange(1000, 11000, 1000):
            for year in ['2007', '2012']:
                for split in ['train', 'val', 'trainval', 'test']:
                    ...
                    self.sets[name] = (lambda split=split, year=year, top_k=top_k:
        ...
        for split in ['train', 'val', 'trainval', 'test']:
            ...
            print name
            self.sets[name] = (lambda split=split:
        ...
        for year in ['2014']:
            for split in ['train', 'val', 'minival', 'valminusminival']:
                ...
                self.sets[name] = (lambda split=split, year=year: coco(split, year))
